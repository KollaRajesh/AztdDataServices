...
namespace demo_1_az_sql_ef_core.Models
{
    ...
    {
        public sqldbaztdContext()
        {
        }

        public sqldbaztdContext(DbContextOptions<sqldbaztdContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Name=ConnectionStrings:sqldbDatabase");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA371A99DD");
